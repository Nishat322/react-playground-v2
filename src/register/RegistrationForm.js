                ...
                <div className = 'registration__hint'>
                    *required field
                    <div className = 'form-group'>
                        ...
                        {this.state.name.touched && <ValidationForm message = {this.validateName()}/>}
                    </div>
                    <div className = 'form-group'>
                        ...
                        {this.state.password.touched && <ValidationForm message = {this.validatePassword()}/>}
                    </div>
                    <div className = 'form-group'>
                        ...
                        {this.state.repeatPassword.touched && <ValidationForm message = {this.validateRepeatPassword()}/>}
                    </div>
